        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card m-b-20">
                    <div class="card-body">                        
                        <h4 class="mt-0 header-title">Edit Application Note Page</h4>
                        <form action="{{route('admin.application_note_edit')}}" method="post" enctype="multipart/form-data">
                        @csrf
                            <div id="img_div">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea  class="form-control ckeditor" name="description" id="long_desc">{{$knowledge->description}}</textarea>
